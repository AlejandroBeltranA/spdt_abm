...
Inputs
    ...
    - Hourly climate parquet (default: data/ncc_2t_timeseries_2010_2026.parquet).
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--climate", default="data/ncc_2t_timeseries_2010_2026.parquet")
...
def main() -> None:
    ...
    cfg = RunConfig(
        ...
        stamp=stamp,
        config_path=(None if str(args.config).lower() == "defaults" else Path(args.config)),
    )
